...
data = {
      1: {
        ...
        'audio2': '../static/Audios/Banda/La Niña Fresa - Banda Zeta.mp3',
      ...
      2: {
         ...
         'audio2': '../static/Audios/Mariachi/Te Vas a Quedar Con las Ganas - Aida Cuevas.mp3',
      ...
      3: {
         ...
         'audio2': '../static/Audios/Norteño/Los Chismes - Chalino Sanchez.mp3',
      ...
      4: {
         ...
         'audio2': '../static/Audios/Son Mexicano/El Tilingo Lingo - Conjunto Jarocho.mp3',
      ...
      5: {
         ...
         'audio2': '../static/Audios/Cumbia Sonidera/Tus Jefes No Me Quieren - Grupo Ensamble.mp3',
      ...
      6: {
         ...
         'audio2': '../static/Audios/Chilena/Mixteca Hermosa - Grupo Santa Cruz.mp3',
